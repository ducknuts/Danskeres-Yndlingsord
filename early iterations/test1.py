...
with codecs.open("C:/Users/Mumle/Desktop/Ordsammenligning/data/ord_database.txt", encoding = 'utf-8') as f:
    for line in f:
        (key, val) = line.split()
